...
# OPUS Containment - OPTION C: HYBRID (Target ~25% MDD)
MAX_DRAWDOWN_SESSION_R = 1.8   # Strict cap (Attempt 4 was 2.0)
MAX_CONSECUTIVE_LOSSES = 3     # Keep 3 loss limit
COOLDOWN_TRADES = 8            # Keep 8 trade cooldown
REGIME_WINDOW = 12             # Smooth regime
MIN_REGIME_EXPECTANCY = -0.3   # Keep same

# OPUS Sizing - BALANCED AGGRESSION
ATTACK_SIZE_MULT = 1.4         # Keep sizing
HOT_STREAK_SIZE_MULT = 1.7     # Keep sizing
FUNDING_SQUEEZE_BONUS = 0.2    # Keep bonus
...
# OPUS Exit - HYBRID
ATR_TRAILING_STOP_MULT = 1.8   # Original wide trail for winners
INITIAL_STOP_ATR = 0.95        # Almost original initial stop
COOLDOWN_ATR = 1.2             # Balanced cooldown

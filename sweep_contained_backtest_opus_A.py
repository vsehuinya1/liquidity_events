...
# OPUS Containment - ALWAYS ATTACK
MAX_DRAWDOWN_SESSION_R = 10.0  # Never kill
MAX_CONSECUTIVE_LOSSES = 10    # Never kill  
COOLDOWN_TRADES = 0            # No cooldown
REGIME_WINDOW = 10             
MIN_REGIME_EXPECTANCY = -5.0   # Always allow

# OPUS Sizing - EXTREME AGGRESSION
ATTACK_SIZE_MULT = 3.0         # Maximum
HOT_STREAK_SIZE_MULT = 4.0     # Ultra
FUNDING_SQUEEZE_BONUS = 1.0    # Double on funding
...
# OPUS Exit - SAME AS ORIGINAL (proven to work)
ATR_TRAILING_STOP_MULT = 1.8   # Original
INITIAL_STOP_ATR = 1.0         # Original

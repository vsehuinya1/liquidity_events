# sweep_contained_backtest_opus_D.py
# OPUS OPTION D: DYNAMIC BURST MODE
# Base: Option C (Survival)
# Burst: Option A (Aggression) when Edge Confirmed
...
# Signal Parameters (Shared) - OPTION E: STRICTER FILTERING
SWEEP_THINNING_MULT = 1.2      
SWEEP_WICK_PCT = 0.45          # Stricter (was 0.35) - Force stronger rejection
MAX_BARS_SINCE_CLUSTER = 20    
CLUSTER_COMPRESSION_RATIO = 0.6  # Stricter (was 0.7) - Force tighter compression
